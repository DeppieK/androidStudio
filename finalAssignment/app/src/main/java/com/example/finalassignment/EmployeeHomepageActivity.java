...
public class EmployeeHomepageActivity extends AppCompatActivity {
    ...
    public void eventList(View view){
        Intent intent = new Intent(EmployeeHomepageActivity.this, EventListActivity.class);
        startActivity(intent);
        finish();
    }

    public void viewStatistics(View view){
        Intent intent = new Intent(EmployeeHomepageActivity.this, StatisticsActivity.class);
        startActivity(intent);
        finish();
    }
}