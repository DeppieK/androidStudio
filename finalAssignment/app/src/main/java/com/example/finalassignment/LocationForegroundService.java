...
public class LocationForegroundService extends Service{
    ...
    private static final long LOCATION_UPDATE_INTERVAL = TimeUnit.MINUTES.toMillis(10); // 10 minutes
        ...
        if (currentUser != null && location != null) {
            ...
            usersRef.orderByChild("email").equalTo(email).addListenerForSingleValueEvent(new ValueEventListener() {
                        ...
                        userSnapshot.getRef().child("location").setValue(currentLocationString)
                                .addOnCompleteListener(task -> {
                                    if (task.isSuccessful()) {
                                        ...
                                        //Toast.makeText(LocationForegroundService.this, "Location update in Firebase successful", Toast.LENGTH_SHORT).show();
                                    } else {
                                        Log.e(TAG, "Failed to update location in Firebase: " + task.getException());
                                        Toast.makeText(LocationForegroundService.this, "Failed to update location in Firebase", Toast.LENGTH_SHORT).show();
                                    }
                                });
                    }
                }
                ...
                public void onCancelled(@NonNull DatabaseError databaseError) {
                    ...
                    Toast.makeText(LocationForegroundService.this, "Database error: " + databaseError.getMessage(), Toast.LENGTH_SHORT).show();
            ...
            Toast.makeText(LocationForegroundService.this, "User is not logged in or location is null", Toast.LENGTH_SHORT).show();
        }
    }
}
